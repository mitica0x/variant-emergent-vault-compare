...
function SurfaceCard({ surface }) {
  ...
  const inner = (
    <>
      <span
        className="absolute top-4 right-4 font-mono text-[10px] uppercase tracking-widest px-2 py-[3px]"
        style={
          lime
    ...
    <section className="hairline-t hairline-b">
      <div className="container-x py-24">
        <div className="flex flex-col gap-3 mb-10">
          ...
          <p className="text-[17px] max-w-2xl leading-relaxed" style={{ color: "rgba(255,255,255,0.6)" }}>
  ...
  return (
    <section className="container-x py-24">
      <div className="mb-8">
        ...
        <p className="mt-4 text-[17px] max-w-2xl leading-relaxed" style={{ color: "rgba(255,255,255,0.6)" }}>
