  ...
  return (
    <div className="p-5 hairline" style={{ borderRadius: 3 }}>
      <div className="flex items-center gap-4">
        <span className="font-mono text-[20px] text-emerald w-6">#{rank}</span>
        ...
        <div className="flex-1">
          ...
          <div className="text-[12px] text-muted mt-[2px]">{e.bestFor}</div>
        </div>
        <span className="font-mono text-[20px] text-emerald">{e._score}</span>
      </div>
      <ul className="mt-3 ml-10 text-[13px] text-muted space-y-1">
        {reasons.map((r) => (
      ...
      <a
        ...
        className="btn-primary mt-4 !text-[12px] !py-2"
      >
...
function LiveRankingPanel({ ranked, answers }) {
  ...
  return (
    <div>
      ...
      <div className="mt-3 text-[13px] text-muted">Updates as you answer.</div>
...
function LiveRankRow({ exchange: e, position, isLast, isMicarCountry }) {
  ...
  return (
    ...
    >
      <span className="font-mono text-[11px] text-muted w-5">#{position + 1}</span>
