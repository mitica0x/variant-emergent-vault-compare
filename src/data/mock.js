...
export const EXCHANGES = [
  exch({
    ...
    score: 91, rank: 1, bestFor: "Security-first long-term holders",
  ...
  exch({
    ...
    score: 89, rank: 2, bestFor: "Deepest global liquidity",
  ...
  exch({
    ...
    score: 86, rank: 3, bestFor: "Active spot + derivatives traders",
  ...
  exch({
    ...
    score: 84, rank: 4, bestFor: "EU traders who want depth + a card",
    ...
    proSummary: "Bybit ranks #4 on our EU/MiCAR leaderboard with an 84. The combination of MiCAR licensing, monthly Proof of Reserves, the deepest derivatives book outside the US, and a card with up to 8% cashback makes it the most complete EU offering today.",
  ...
  exch({
    ...
    score: 83, rank: 5, bestFor: "Newcomers prioritizing trust",
  ...
  // ---- Added venues (scores + non-score fields estimated from public data) ----
  exch({
    id: "upbit", name: "Upbit", slug: "upbit", domain: "upbit.com",
    score: 78, rank: 23, bestFor: "South Korea's largest exchange by volume",
    micarLicensed: false, hasCryptoCard: false, hasFutures: false, hasStaking: true,
    type: ["all", "spot"],
    vol24h: "$4.1B", vol24hDelta: 0, spreadBTC: 0.08, uptime90d: 99.91,
    porCadence: "N/A", tradingFeeLow: 0.05, tradingFeeHigh: 0.25,
    affiliateUrl: "https://upbit.com/",
    scoreBreakdown: { security: 76, compliance: 62, liquidity: 88, por: 70, trackRecord: 82, productDepth: 72 },
    proSummary: "South Korea's largest exchange by volume.",
    estimated: true,
  }),
  exch({
    id: "bingx", name: "BingX", slug: "bingx", domain: "bingx.com",
    score: 72, rank: 24, bestFor: "Copy trading and social trading platform",
    micarLicensed: false, hasCryptoCard: false, hasFutures: true, hasStaking: false,
    type: ["all", "spot", "derivatives"],
    vol24h: "$1.8B", vol24hDelta: 0, spreadBTC: 0.12, uptime90d: 99.80,
    porCadence: "N/A", tradingFeeLow: 0.10, tradingFeeHigh: 0.10,
    affiliateUrl: "https://bingx.com/",
    scoreBreakdown: { security: 68, compliance: 60, liquidity: 74, por: 65, trackRecord: 64, productDepth: 76 },
    proSummary: "Copy trading and social trading platform.",
    estimated: true,
  }),
  exch({
    id: "bitmart", name: "BitMart", slug: "bitmart", domain: "bitmart.com",
    score: 65, rank: 25, bestFor: "Global exchange with wide altcoin selection",
    micarLicensed: false, hasCryptoCard: false, hasFutures: true, hasStaking: false,
    type: ["all", "spot", "derivatives"],
    vol24h: "$980M", vol24hDelta: 0, spreadBTC: 0.18, uptime90d: 99.60,
    porCadence: "N/A", tradingFeeLow: 0.10, tradingFeeHigh: 0.25,
    affiliateUrl: "https://www.bitmart.com/",
    scoreBreakdown: { security: 58, compliance: 55, liquidity: 68, por: 60, trackRecord: 58, productDepth: 74 },
    proSummary: "Global exchange with wide altcoin selection.",
    estimated: true,
  }),
  exch({
    id: "bitpanda", name: "Bitpanda", slug: "bitpanda", domain: "bitpanda.com",
    score: 84, rank: 26, bestFor: "EU-native MiCAR-compliant crypto and multi-asset platform",
    micarLicensed: true, hasCryptoCard: true, hasFutures: false, hasStaking: true,
    type: ["all", "spot"],
    vol24h: "$320M", vol24hDelta: 0, spreadBTC: 0.15, uptime90d: 99.94,
    porCadence: "N/A", tradingFeeLow: 0.15, tradingFeeHigh: 1.49,
    affiliateUrl: "https://www.bitpanda.com/",
    scoreBreakdown: { security: 86, compliance: 92, liquidity: 74, por: 85, trackRecord: 82, productDepth: 80 },
    proSummary: "EU-native MiCAR-compliant crypto and multi-asset platform.",
    estimated: true,
  }),
  exch({
    id: "bithumb", name: "Bithumb", slug: "bithumb", domain: "bithumb.com",
    score: 74, rank: 27, bestFor: "South Korea's second-largest exchange",
    micarLicensed: false, hasCryptoCard: false, hasFutures: false, hasStaking: true,
    type: ["all", "spot"],
    vol24h: "$1.2B", vol24hDelta: 0, spreadBTC: 0.10, uptime90d: 99.85,
    porCadence: "N/A", tradingFeeLow: 0.04, tradingFeeHigh: 0.25,
    affiliateUrl: "https://www.bithumb.com/",
    scoreBreakdown: { security: 72, compliance: 64, liquidity: 80, por: 68, trackRecord: 76, productDepth: 70 },
    proSummary: "South Korea's second-largest exchange.",
    estimated: true,
  }),
  exch({
    id: "lbank", name: "LBank", slug: "lbank", domain: "lbank.com",
    score: 60, rank: 28, bestFor: "Mid-tier global exchange focused on altcoin listings",
    micarLicensed: false, hasCryptoCard: false, hasFutures: true, hasStaking: false,
    type: ["all", "spot", "derivatives"],
    vol24h: "$620M", vol24hDelta: 0, spreadBTC: 0.22, uptime90d: 99.50,
    porCadence: "N/A", tradingFeeLow: 0.10, tradingFeeHigh: 0.20,
    affiliateUrl: "https://www.lbank.com/",
    scoreBreakdown: { security: 55, compliance: 50, liquidity: 62, por: 55, trackRecord: 54, productDepth: 68 },
    proSummary: "Mid-tier global exchange focused on altcoin listings.",
    estimated: true,
  }),
  exch({
    id: "xtcom", name: "XT.com", slug: "xtcom", domain: "xt.com",
    score: 62, rank: 29, bestFor: "Global CEX with broad token coverage",
    micarLicensed: false, hasCryptoCard: false, hasFutures: true, hasStaking: false,
    type: ["all", "spot", "derivatives"],
    vol24h: "$720M", vol24hDelta: 0, spreadBTC: 0.20, uptime90d: 99.55,
    porCadence: "N/A", tradingFeeLow: 0.10, tradingFeeHigh: 0.20,
    affiliateUrl: "https://www.xt.com/",
    scoreBreakdown: { security: 58, compliance: 52, liquidity: 64, por: 58, trackRecord: 56, productDepth: 70 },
    proSummary: "Global CEX with broad token coverage.",
    estimated: true,
  }),
  exch({
    id: "deribit", name: "Deribit", slug: "deribit", domain: "deribit.com",
    score: 86, rank: 30, bestFor: "#1 crypto options exchange by volume globally",
    micarLicensed: false, hasCryptoCard: false, hasFutures: true, hasStaking: false,
    type: ["all", "derivatives"],
    vol24h: "$2.4B", vol24hDelta: 0, spreadBTC: 0.04, uptime90d: 99.97,
    porCadence: "N/A", tradingFeeLow: 0.00, tradingFeeHigh: 0.05,
    affiliateUrl: "https://www.deribit.com/",
    scoreBreakdown: { security: 84, compliance: 72, liquidity: 92, por: 80, trackRecord: 88, productDepth: 96 },
    proSummary: "#1 crypto options exchange by volume globally.",
    estimated: true,
  }),
  exch({
    id: "aster", name: "Aster", slug: "aster", domain: "asterdex.com",
    score: 74, rank: 31, bestFor: "High-performance perps DEX, top 3 by weekly volume",
    micarLicensed: false, hasCryptoCard: false, hasFutures: true, hasStaking: false,
    type: ["all", "dex", "derivatives"],
    vol24h: "$890M", vol24hDelta: 0, spreadBTC: 0.05, uptime90d: 99.80,
    porCadence: "None", tradingFeeLow: 0.02, tradingFeeHigh: 0.05,
    affiliateUrl: "https://www.asterdex.com/",
    scoreBreakdown: { security: 80, compliance: 50, liquidity: 78, por: 72, trackRecord: 58, productDepth: 74 },
    proSummary: "High-performance perps DEX, top 3 by weekly volume.",
    estimated: true,
  }),
  exch({
    id: "meteora", name: "Meteora", slug: "meteora", domain: "meteora.ag",
    score: 72, rank: 32, bestFor: "Dynamic liquidity protocol on Solana",
    micarLicensed: false, hasCryptoCard: false, hasFutures: false, hasStaking: false,
    type: ["all", "dex"],
    vol24h: "$680M", vol24hDelta: 0, spreadBTC: 0.06, uptime90d: 99.75,
    porCadence: "None", tradingFeeLow: 0.05, tradingFeeHigh: 0.30,
    affiliateUrl: "https://www.meteora.ag/",
    scoreBreakdown: { security: 78, compliance: 48, liquidity: 74, por: 70, trackRecord: 56, productDepth: 70 },
    proSummary: "Dynamic liquidity protocol on Solana.",
    estimated: true,
  }),
  exch({
    id: "aerodrome", name: "Aerodrome", slug: "aerodrome", domain: "aerodrome.finance",
    score: 76, rank: 33, bestFor: "#1 DEX on Base chain by TVL and volume",
    micarLicensed: false, hasCryptoCard: false, hasFutures: false, hasStaking: true,
    type: ["all", "dex"],
    vol24h: "$740M", vol24hDelta: 0, spreadBTC: 0.06, uptime90d: 99.82,
    porCadence: "None", tradingFeeLow: 0.05, tradingFeeHigh: 0.30,
    affiliateUrl: "https://aerodrome.finance/",
    scoreBreakdown: { security: 82, compliance: 50, liquidity: 80, por: 74, trackRecord: 60, productDepth: 72 },
    proSummary: "#1 DEX on Base chain by TVL and volume.",
    estimated: true,
  }),
  exch({
    id: "camelot", name: "Camelot", slug: "camelot", domain: "camelot.exchange",
    score: 68, rank: 34, bestFor: "Native Arbitrum DEX with concentrated liquidity",
    micarLicensed: false, hasCryptoCard: false, hasFutures: false, hasStaking: true,
    type: ["all", "dex"],
    vol24h: "$280M", vol24hDelta: 0, spreadBTC: 0.08, uptime90d: 99.70,
    porCadence: "None", tradingFeeLow: 0.05, tradingFeeHigh: 0.30,
    affiliateUrl: "https://app.camelot.exchange/",
    scoreBreakdown: { security: 74, compliance: 46, liquidity: 68, por: 66, trackRecord: 58, productDepth: 66 },
    proSummary: "Native Arbitrum DEX with concentrated liquidity.",
    estimated: true,
  }),
  exch({
    id: "sushiswap", name: "SushiSwap", slug: "sushiswap", domain: "sushi.com",
    score: 70, rank: 35, bestFor: "Veteran multi-chain DEX with broad ecosystem",
    micarLicensed: false, hasCryptoCard: false, hasFutures: false, hasStaking: true,
    type: ["all", "dex"],
    vol24h: "$340M", vol24hDelta: 0, spreadBTC: 0.10, uptime90d: 99.65,
    porCadence: "None", tradingFeeLow: 0.05, tradingFeeHigh: 0.30,
    affiliateUrl: "https://www.sushi.com/",
    scoreBreakdown: { security: 76, compliance: 48, liquidity: 72, por: 68, trackRecord: 72, productDepth: 74 },
    proSummary: "Veteran multi-chain DEX with broad ecosystem.",
    estimated: true,
  }),
  exch({
    id: "raydium", name: "Raydium", slug: "raydium", domain: "raydium.io",
    score: 78, rank: 36, bestFor: "Leading AMM and liquidity hub on Solana",
    micarLicensed: false, hasCryptoCard: false, hasFutures: false, hasStaking: true,
    type: ["all", "dex"],
    vol24h: "$920M", vol24hDelta: 0, spreadBTC: 0.05, uptime90d: 99.85,
    porCadence: "None", tradingFeeLow: 0.05, tradingFeeHigh: 0.30,
    affiliateUrl: "https://raydium.io/",
    scoreBreakdown: { security: 80, compliance: 50, liquidity: 82, por: 72, trackRecord: 68, productDepth: 76 },
