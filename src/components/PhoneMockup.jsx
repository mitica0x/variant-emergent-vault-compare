...
export const PhoneMockup = ({ screenshots, abbreviation, screenshot, fallback }) => {
  ...
  return (
    ...
    >
      ...
      {/* FRAME */}
      <div className="absolute inset-0 overflow-hidden" style={{ borderRadius: "50px", background: "linear-gradient(135deg, #2A2A2C 0%, #1F1F21 38%, #1C1C1E 62%, #131315 100%)", boxShadow: "inset 0 0 0 1px rgba(255,255,255,0.06), inset 0 1.5px 0 rgba(255,255,255,0.08), inset 0 -2px 0 rgba(0,0,0,0.55)" }}>
        ...
        <div aria-hidden="true" className="absolute pointer-events-none" style={{ top: "16px", left: "0", right: "0", height: "70px", background: "linear-gradient(180deg, rgba(255,255,255,0.05) 0%, rgba(255,255,255,0.015) 35%, rgba(0,0,0,0.30) 80%, rgba(0,0,0,0.45) 100%)", borderTop: "1px solid rgba(255,255,255,0.08)", borderBottom: "1px solid rgba(0,0,0,0.45)" }} />
        <div className="absolute" style={{ top: "3px", left: "3px", right: "3px", bottom: "3px", borderRadius: "47px", background: "rgba(0,0,0,0.18)", boxShadow: "inset 0 0 0 1px rgba(0,0,0,0.55), inset 0 1px 2px rgba(0,0,0,0.35)" }}>
          <div className="absolute" style={{ top: "6px", left: "6px", right: "6px", bottom: "6px", borderRadius: "42px", background: "#000", overflow: "hidden" }}>
            <div className="relative w-full h-full overflow-hidden" style={{ background: "#000" }}>
              ...
              {/* HOME INDICATOR */}
              <div aria-hidden="true" style={{ position: "absolute", bottom: "10px", left: "50%", transform: "translateX(-50%)", width: "120px", height: "5px", borderRadius: "3px", background: "rgba(255,255,255,0.5)", zIndex: 5 }} />
